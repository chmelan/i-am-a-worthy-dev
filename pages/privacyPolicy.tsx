export default function PrivacyPolicy() {
  return (
    <div>
      <h1>Privacy Policy for iamaworthy.dev</h1>

      <p>
        At I am a worthy dev , accessible from iamaworthy.dev, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by I am a
        worthy dev and how we use it.
      </p>
      ...
      <p>
        iamaworthy.dev legal basis for collecting and using the personal
      ...
      <ul>
        <li>iamaworthy.dev needs to perform a contract with you</li>
        <li>You have given iamaworthy.dev permission to do so</li>
        <li>
          Processing your personal information is in iamaworthy.dev legitimate
          interests
        </li>
        <li>iamaworthy.dev needs to comply with the law</li>
      </ul>

      <p>
        iamaworthy.dev will retain your personal information only for as long as
      ...
      <p>
        I am a worthy dev follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of I am a worthy dev .
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on I am a worthy dev , which are
      ...
      <p>
        Note that I am a worthy dev has no access to or control over these
      ...
      <p>
        I am a worthy dev 's Privacy Policy does not apply to other advertisers
      ...
      <p>
        I am a worthy dev does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        to the information that they shared and/or collect in I am a worthy dev
